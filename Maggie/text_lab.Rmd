...
```{r}
#Sentiment analysis
get_sentiments('afinn')# we see a list of words and there classification, 2,477 - not really that many overall. 
get_sentiments('nrc')# looks like a good amount more 13,875, but as we can see words are classified in several different categories. 
get_sentiments('bing')# looks like a good amount more 6,786, but as we can see just negative and positive. 
...
ggplot(data = texas_sentiment_affin, 
  ...
  geom_histogram()+
  ggtitle("Texas Monthly Sentiment Range")+
  theme_minimal()
...
ggplot(data = atlanta_sentiment_affin, 
  ...
  geom_histogram()+
  ggtitle("The Atlanta Journal Sentiment Range")+
  theme_minimal()
